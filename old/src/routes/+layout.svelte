	...
	<svelte:fragment slot="header">
		...
		<AppBar>
			<svelte:fragment slot="headline">
				<a class="variant-ringed-primary block p-4" href="{base}/resources" rel="noreferrer"
					>Resources</a
				>
			</svelte:fragment>
			...
			<svelte:fragment slot="trail">
				<a class="btn btn-md variant-filled-primary" href="{base}/register" rel="noreferrer">
					Register
				</a>
			</svelte:fragment>
		</AppBar>
