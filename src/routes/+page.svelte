...
<div class="container h-full mx-auto flex justify-center items-center">
	<div class="space-y-10 flex flex-col items-center">
		...
		<article class="text-center">
			<p class="text-primary-400">Elementary: November 9th 2024</p>			
			<p class="text-primary-400">Secondary: November 16th 2024</p>
			<p>Logan Library 285 N Main St. Logan, UT 84321</p>
		</article>
